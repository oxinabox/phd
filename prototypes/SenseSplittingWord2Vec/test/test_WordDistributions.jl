...
facts() do 
	...
	@fact subsampled_wordcount(.00005, Dict("a"=> 6f0/12, "b"=> 2f0/12, "c"=>4f0/12), 100) --> less_than(100)
	@fact subsampled_wordcount(.00005, Dict("a"=> 6f0/12, "b"=> 2f0/12, "c"=>4f0/12), 100) --> greater_than(0)
