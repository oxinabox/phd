...
\pdfcomment{Maybe rewrite this as p_dimm where dim is sat, hue or val, and leave the n implict. and call PP_std tilde(PP). That would let the MSE also be described with the same set of definitions}
