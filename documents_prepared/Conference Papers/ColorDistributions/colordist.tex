...
Thus the need for true distribution estimation.
...
such that when a listener is presented with the same color patches in randomized order they select the discribed color.
...
this probability distribution is always Gaussian -- both symmetric and unimodal -- albeit in a high-dimensional non-linear color space.
...
Existing works do not aim to aiming to estimate a general distribution so are unsuitable for comparison
...
\pdfcomment{This is a really wierd definition, how can I make it more clear?}
