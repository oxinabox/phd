...
If it can also have similar performance for cases that do require compositional understanding (see \Cref{sec:extrapodataset}) that that would show that it is indeed achieving the goal of properly modelling the language use.
