...
We expect  (as discussed in \Cref{sec:discretization-and-blurring}) this continuousness, where adjacent points in color space have similar probability values.
