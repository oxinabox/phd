...
There exists a large prior body of word for determining the name of a color, as well as several works relating to determining the color of a name, however to our knowledge there are no other works on determining the distribution in color-space for a name when using large scale data of millions of observations for hundreds of color names.
...
The XKCD color survey \parencite{Monroe2010XKCDdataset}, collected over 3.4 million observations, in the form of color-name pairs, from over 222,500 respondents, using this Monroe identified 954 color names.
