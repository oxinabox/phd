...
This is not the solo motivation -- there is also the important factors of knowing the confidance of a particular sample of colorspace, and understanding the other factors of the distribution, eg spread and more general shape.
As well as the linquistic interest in how the modifier words influence the colours, and the capacity to combine terms in ways never seen in the training data.
