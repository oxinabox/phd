...
\begin{frame}{What makes a embedding method good?}
...
\begin{frame}[fragile]{Paraphrase groups from MSRP}
	...
	\begin{itemize}
		...
		\only<2>{\item belcher said the airport 's conference room \blert{was serving as a makeshift } shelter for several \clert{area families } who hiked up the \alert{wooded hillside} in advance of rising water .}
		\only<2>{\item belcher said the airport 's conference room \blert{became a } shelter for several \clert{area families } who had hiked up \alert{wooded hillsides} in advance of rising water .}
		\only<2>{\item belcher said the airport 's conference room \blert{became a } shelter for several \clert{families } who had hiked up \alert{hillsides} ahead of rising water .}
...
\begin{frame}[fragile]{Paraphrase groups from Opinosis}
	\begin{itemize}
		...
		\only<2>{\item Best location in Fisherman's Wharf .}
		\only<2>{\item Perfect location to Fishermans Wharf .}
		\only<2>{\item Perfect Fisherman's Wharf Location}
		\only<2>{\item Perfect location near Fisherman's Wharf .}
		\only<2>{\item The location is great, only 2 blocks from Fisherman's Wharf .}
...
\begin{frame}{Bag of Words (BOW / PCA BOW)}
	...
	\begin{block}{Why Principle Component Analysis?}
		Unsupervised dimensionality reduction, to test if BOW performance was due only to its very large number of dimensions.
	\end{block}
...
\begin{frame} {{Paragraph Vector -- Distributed Memory}}
	...
	\begin{itemize}
		...
		\item Based on a language modelling task
...
\begin{frame}{Limitations}
	\begin{itemize}
	\item Embedding Training corpus was fully distinct from evaluation corpus
...
\begin{frame}[fragile]{Conclusion}
	...
	\begin{itemize}
	\item We evaluated partitioning of vector space by semantic equivalence.
	\item We used a linear SVM for this semantic classification task
