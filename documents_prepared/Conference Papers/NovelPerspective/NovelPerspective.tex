...
\pgfplotstableset{col sep=comma, header=has colnames,
	...
	columns/Testset/.style={stringcol},
...
and take the element-wise mean of this concentented vector over all occurrences of the named entity.
...
We report overall accuracy, and the micro-averaged precision, recall and F1-score \parencite{SOKOLOVA2009427}.
