...
\pdfcomment{this paragraph could be cleaner}
...
The different feature sets correspond to different \textbf{Feature Extraction} steps in \Cref{fig:classify}.
...
is getting 1 additional test case correct, and so may not be significant. \pdfcomment{Can I get some p-values on this?}
