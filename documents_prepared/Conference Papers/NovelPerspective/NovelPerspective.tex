...
\begin{abstract}
We present NovelPerspective: a proof-of-concept tool to allow consumers to subset their digital literature, based on point of view (POV) character.
...
It seems that the classical feature are more robust; both with smaller training sets (like SOC), and with more difficult test sets (like WOT).
With more training data, it would be reasonable to more features (e.g. additional adjacent words),
by doing this it may be that word embedding may prove better.
