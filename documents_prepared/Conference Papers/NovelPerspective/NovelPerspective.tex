...
as has been commonly used with word embeddings .



\pdfcomment{Put what  classifier was finally used for higher dimensional features}

\pdfcomment{Theoretically, a better loss function would be a variation on the multi-class hinge-loss \parencite{dogan2016multiclassSVM}, where the objective would be for the true named entity to score higher than any of the other named entities extracted from the same text.}
