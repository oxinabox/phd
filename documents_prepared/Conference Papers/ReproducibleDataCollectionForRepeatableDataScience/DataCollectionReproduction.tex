...
\rhead{\textcolor{gray}{{DataDeps.jl -- Reproducible Data Setup For Repeatable Data and Computational Science}}}
...
\begin{lstlisting}[frame=single, caption={Example registration block for Word Net. The majority of it is a message for the user.}] 
