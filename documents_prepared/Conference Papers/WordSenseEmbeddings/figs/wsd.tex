...
\node[datastore, below=0.3 of lemma](wordnet){WordNet \\Sense Inventory};

\node[datastore, below=0.3 of word](embeddings) {Pretrained Unsupervised \\ Sense Embeddings};
\node[proc, below=2.4 of POS] (refitting) {Refitting};

\node[proc, below = 1.2 of refitting] (WSD) {Lexical WSD};
