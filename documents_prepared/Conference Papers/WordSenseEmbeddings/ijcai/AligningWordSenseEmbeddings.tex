...
Refitting can also be used to fit to an user provided example, giving a specific sense vector for that use.
...
We hypothesize that the sharpness of probability estimates from \Cref{eq:generalwsd} is a result of data sparsity, and of a false independence assumption in \Cref{eq:contextprobtrue}. This sharpness is a problem that was particularly noted for for for n-gram language models \cite{rosenfeld2000two}.
...
Historically, the state of the art systems are very different in functioning, and are directly approaching the task. %\parencite{Navigli:2007:STC:1621474.1621480,moro2015semeval,navigli2013semeval}.
