...
}\begin{displaymath} \DIFdel{%DIFDELCMD < \label{eq:agireewsd}%%%
...
\DIFdelbegin \DIFdel{:
}\begin{displaymath} \DIFdel{%DIFDELCMD < \label{eq:contrextprobsmooth}%%%
P_S(\c \mid s_{i})=\prod_{\forall w_{j}\in\c}\sqrt[n_c}]{\DIFdel{P(w_{j} \mid s_{i})}}
\end{displaymath}
%DIFAUXCMD
%DIFDELCMD < 
...
\DIFdelbegin \begin{displaymath} \DIFdel{%DIFDELCMD < \label{eq:priorsmoothed}%%%
P_S(s_{i})= \sqrt[n_c}]{\DIFdel{P(w_{j} \mid s_{i})}}
\end{displaymath}
%DIFAUXCMD
...
\DIFdelbegin \begin{displaymath} \DIFdel{%DIFDELCMD < \label{eq:generalwsdsmoothed}%%%
\begin{aligned}
P_S(s_{i}\mid\c) %
...
\DIFdelbegin \begin{align*} \DIFdel{%DIFDELCMD < \label{eq:refittedsim}%%%
