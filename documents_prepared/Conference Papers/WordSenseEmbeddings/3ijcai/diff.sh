...
$LATEXDIFF -V --math-markup=0 --exclude-safecmd="section,subsection,subsubsection" --exclude-textcmd="section,subsection,subsubsection" www_version.tex "AligningWordSenseEmbeddings.tex"  > diff.tex
