...
%of time complexity lower than for the current standard AvgSimC used by competing systems.
...
The faster similarity measure has applications in information retrieval, where improved speed is required to allow comparisons on web-scale document collections.
