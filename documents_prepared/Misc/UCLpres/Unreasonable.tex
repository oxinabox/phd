...
\begin{frame}{For trigram language models, word ordering is a variation of travelling salesman}
	\resizebox{0.9\textwidth}{!}{\input{figs/ordergraphpaper.tex}}
...
\begin{frame}{How well can word order actually be recovered?} %Hack: I can't get \only working within a plot so just repeat it 3 times
