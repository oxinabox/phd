...
\begin{frame}{Some reasons why lexical semantics is capturing what looks like sentence semantics.}
	\cite{ac2018probingsentencevectors}\\
	Most words have same \emph{temporal tense} as sentence.\\
	\emph{Nouns and adjectives} both tend to mark \emph{quantities} of same things.\\
	The presence of some words \emph{(Why, Where, etc)} strongly hints at the \emph{structure of the sentence}.
