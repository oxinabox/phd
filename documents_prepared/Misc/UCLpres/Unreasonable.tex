...
\begin{frame}{SkipGram is the most well known of recent word embedding methods}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\node[draw,circle,green,left=0.8 of w1](ww1) at (0,0) {$w_{i}$};
...
\begin{frame}{So SkipGrams are a \\ dimensionality reduction algorithm,\\ that tries remember collocated words}
	\begin{itemize}
		\item \emph{PCA} is a dimensionality reduction algorithm, that tries to remember the most variant factors
