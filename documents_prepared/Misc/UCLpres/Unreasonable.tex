...
\begin{frame}{You can just add up word embeddings and uses it as a representation}
	\begin{block}{\citehere{acl2018bleuopposedmeaning}}
	...
	\begin{block}{\citehere{ac2018probingsentencevectors}}
...
\begin{frame}{What does it mean to partition readily?}
	...
	\begin{description}%[labelsep=1em]
		...
		\item[Concentrated]\quad  Sentences with same meaning go to small area.     			
	\end{description}
