...
\addtobeamertemplate{frametitle}{}{\vskip-0.8cm}
...
\title[Semantic Vectors]{Semantic Vector Representations for Natural Languages}
\author[L.~White]{
...
\begin{frame}{Applications: Full Cycle} 
	\centering\resizebox{!}{0.6\textheight}{\includegraphics{./workflow}}
	\begin{itemize}
...
\begin{frame} {NN with Embedding Look Up}
	\centering
	\resizebox{!}{0.7\textheight}{\input{../figs/LU_NN2.pgf}}
	
	\rightskip 1ex \colorbox{lime}{Tune:	$W_i,\b_i,\x_j$}
\end{frame}

\begin{frame} {Neural Probabalistic LM}
	\centering\resizebox{!}{0.8\textheight}{\input{../figs/NPLM1.pgf}}
	\footfullcite{NPLM}
\end{frame}

\begin{frame} {Neural Probabalistic LM}
	\centering\resizebox{!}{0.8\textheight}{\input{../figs/NPLM2.pgf}}
	\footfullcite{NPLM}
\end{frame}

\begin{frame} {Neural Probabalistic LM}
	\centering\resizebox{!}{0.8\textheight}{\input{../figs/NPLM3.pgf}}
	\footfullcite{NPLM}
	...
	\note{\begin{itemize}
		...
		\item make the task to use one word embedding to work out all the context works and you get Skip-Grams.
...
\begin{frame}{Word Embeddings}
	\begin{columns}
		...
		\end{column}
	\end{columns}
	\footfullcite{mikolov2013efficient}
\end{frame}

\begin{frame} {PV DM} 
	\hskip-1cm
	\resizebox{!}{0.8\textheight}{\input{../figs/PVDM1.pgf}}
...
\begin{frame} {PV DM} 
	\hskip-1cm
	\resizebox{!}{0.8\textheight}{\input{../figs/PVDM2.pgf}}
	\footfullcite{le2014distributed}
\end{frame}
...
\begin{frame} {PV DM}
	\hskip-1cm
	\resizebox{!}{0.8\textheight}{\input{../figs/PVDM3.pgf}}
	\footfullcite{le2014distributed}
...
\begin{frame} {Paragraph Vectors}
	\centering\resizebox{!}{0.4\textheight}{\input{../figs/PVDM3_no_label.pgf}}
	\vskip3ex
	\begin{itemize}
...
\begin{frame}{Resynthesis}
	\begin{itemize}
		...
		\begin{itemize}
			\item By embedding whole vocabulary
		\end{itemize}
		\item Sentence Embeddings are not (trivially) Reversible
...
\begin{frame}{Sum of Word Embeddings}
	\centering\resizebox{\textwidth}{!}{\input{../figs/SOWE.pgf}}
\end{frame}

\begin{frame}{SOWE Resynthesizing}
	\centering\resizebox{\textwidth}{!}{\input{../figs/SOWE3.pgf}}
\end{frame}

\begin{frame}{SOWE Resynthesizing}
	\centering\resizebox{\textwidth}{!}{\input{../figs/SOWE1.pgf}}
\end{frame}



\begin{frame} {Semantically Constrained URAE}
	\vskip 2ex
	\hskip -1.6cm
	\resizebox{!}{0.8\textheight}{\input{../figs/semanticURAE.pgf}}
	\footfullcite{zhang2014BRAE}
\end{frame}
...
instead proposing a URAE with the same language, but with Paraphrases.
	}
...
\begin{frame}{Proposal}
	\begin{itemize}
		...
		\begin{itemize}
			\item Subset Sum, with Heuristics
		\end{itemize}
		\item Semantically constrained URAE
		\begin{itemize}
