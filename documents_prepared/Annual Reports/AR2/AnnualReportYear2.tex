...
In another case circumstances outside our control rendered continuation of a project impractical.
...
At around this time had the opportunity to speak to the guest presenter Dr Hien Nguyen, at the Big Data Master Class.
...
such research has application as a complainant of in user input systems (such as intent recognition), and in natural language generation systems (such as captioning). It also has direct applications as a teaching tool for English language learners, and as an accessibility aid for the visually impaired.
...
As mentioned above, Dr Liu has took maternity leave, in December 2016.
She is not expected to fully return until 2018.
The loss of ready access to Dr Liu's advice and expertise is an issue.
Currently, it is planned to begin seeing Dr Liu at meetings again in the coming weeks; of-course her availability will remain restricted.
As a step toward handling this problem, research projects where her specific expertise is required, such as the Water Meaning project have been put on hold.
...
This will involved large scale updating and refining the literature review produced for the research proposal.
...
Dissertation preparation will also involved enhancing the supplementary materials from the prior papers.
