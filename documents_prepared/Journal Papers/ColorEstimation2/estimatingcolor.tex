...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	extrapodistresults/.append style={
		...
		columns/nonextrapolatingperp/.style={column name=$PP$},
		columns/extrapolatingperp/.style={column name=$PP$},
%		
		...
		columns/xperpstd/.style={column name=$\frac{PP}{256^3}$},
		columns/nxperpstd/.style={column name=$\frac{PP}{256^3}$}
	}
}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
%	\pgfplotstabletypeset[pointresults]{results/res_point_comb_extrapo.csv}
	%	}
