...
All three input modules use pretrained FastText embeddings \parencite{bojanowski2016enriching} to represent the individual tokens making up the color names, but combine them using difference mechanisms.
