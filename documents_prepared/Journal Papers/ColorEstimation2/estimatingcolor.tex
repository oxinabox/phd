...
\begin{table}
	...
	\pgfplotstabletypeset[distresults]{results/dist_full.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[distresults]{results/dist_ord.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[distresults]{results/dist_extrapo.csv}
	%	}
...
\pgfplotstableset{distpointresults/.append style={%
		columns={method,mse_to_distmean},
		columns/method/.style={string type, column name={Mean from distribution estimation method}},
		columns/mse_to_distmean/.style={column name={MSE}},
	}%
}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[pointresults]{results/point_full.csv}
	\pgfplotstabletypeset[distpointresults]{results/dist_full.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[pointresults]{results/point_ord.csv}
	\pgfplotstabletypeset[distpointresults]{results/dist_ord.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[pointresults]{results/point_extrapo.csv}
	\pgfplotstabletypeset[distpointresults]{results/dist_extrapo.csv}
	%	}
