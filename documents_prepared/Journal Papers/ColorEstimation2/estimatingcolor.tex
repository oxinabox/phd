...
In the examples shown in \Cref{fig:oovdist} and \Cref{fig:oovpoint}, the terms are never occurred in the training data at all, but out models exploit the fact that they work by transforming the word-embedding space to predict the colors.
...
\begin{figure}
	\distfigs{{SOWE, CNN, RNN}}{\oovcolors}	
