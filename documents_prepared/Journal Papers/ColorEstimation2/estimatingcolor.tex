...
To establish a rough upper-limit on the modeling results we evaluate a direct method which bypasses the language understanding component of the task.
...
This operational upper bound bypasses the compositional language understanding part of the process.
