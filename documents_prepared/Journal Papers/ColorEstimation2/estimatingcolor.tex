...
\section{Results}
\pdfcomment{IMPORTANT: Current Results are on the Dev Sets. Expriments need to be rerun on the Test Sets}
\subsection{Distribution Estimation}
\pgfkeys{
	/pgf/number format/.cd, fixed relative,precision=3, fixed zerofill=true
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	extrapodistresults/.append style={
		columns={method, extrapolatingperp, nonextrapolatingperp, xperpstd, nxperpstd},
		columns/nonextrapolatingperp/.style={column name={Extrapolating $PP$}},
		columns/extrapolatingperp/.style={column name={Extrapolating $PP$}},
%		
		...
		columns/xperpstd/.style={column name={Extrapolating $\frac{PP}{256^3}$}},
		columns/nxperpstd/.style={column name={NonExtrapolating $\frac{PP}{256^3}$}}
	}
}
\subsubsection{Full Task}
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[distresults]{results/res_dist_full.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[distresults]{results/res_dist_ord.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
\pgfplotstabletypeset[extrapodistresults]{results/res_dist_extrapo.csv}
	%	}
	\caption{\label{tbl:distextrapo} The results for the \textbf{extrapolation distribution estimation task}. Lower perplexity (PP) is better. This is a subset of the full test set containing only tests of rare word combinations. In the extrapolating methods those word combinations were removed from the training and development sets.}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pgfplotstableset{pointresults/.append style={%
	...
	extrapopointresults/.append style={
		columns={method, extrapolatingmse, nonextrapolatingmse},
		columns/nonextrapolatingmse/.style={column name={Extrapolating MSE}},
		columns/extrapolatingmse/.style={column name={Extrapolating MSE}}
	}
}
\subsubsection{Full Task}
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[pointresults]{results/res_point_comb_full.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[pointresults]{results/res_point_comb_ord.csv}
	%	}
...
\begin{table}
	%	\resizebox{\columnwidth}{!}{
	\pgfplotstabletypeset[extrapopointresults]{results/res_point_comb_extrapo.csv}
	%	}
