...
%
As such represent an approximate upper bound on performance as they can exploit the observations without issue of determining how to compose the tokens.
This is a useful baseline, as our neural models (SOWE, CNN, and RNN)
...
\subsubsection{\empmodel{} for Point Estimation: Mean-point}
