...
\begin{figure}
	...
	ylabel={Channelwise mean of cross entropy},
	ymin=13.5, ymax=17
	]
	\addplot table [y=SOWE, x=Step, col sep=comma] {results/training/distest.csv};
	\addplot table [y=CNN, x=Step, col sep=comma] {results/training/distest.csv};
	\addplot table [y=RNN, x=Step, col sep=comma] {results/training/distest.csv};
	\legend{{SOWE},{CNN},{RNN}};
	\end{axis}
	\end{tikzpicture}
...
\begin{figure}
	...
	\begin{axis}[
		...
		ylabel={Channelwise mean of MSE},
...
\todo{Say something about training set loss. Also: Right now the distribution plot shows Cross Entropy, but the main results are written in perplexity. They are monotonically related, and I think I can mathematically convert one to the other, but I'ld have to work out how.}
