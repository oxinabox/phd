...
From the consideration of all results \Cref{tbl:pointfull,tbl:distfull,tbl:distord,tbl:pointord,tbl:pointextrapo,tbl:distextrapo}.
...
However, as shown \Cref{sec:quantitative-results} it did learn generally acceptable colors, however it is not as close a match to the population's expectation.
...
This means that that distribution estimating models fits to all color names with equal priority.% \pdfcomment{Can a good analogy to microaveraging and macroaveraging be made?}.
