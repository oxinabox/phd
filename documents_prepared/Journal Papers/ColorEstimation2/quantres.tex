...
While for point estimation (\Cref{fig:pointtrainloss,tbl:pointfull}), on the test set CNN and SOWE perform similarly, while RNNs perform much worse, while in training the performance of CNN is roughly midway between SOWE and the RNNs.
