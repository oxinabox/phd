...
\begin{figure}
	\resizebox{\textwidth}{!}{
		\distfigs{{Direct/{Training Data}, Direct-smoothed/{\shortstack{Non-compositional\\ Baseline}}, SOWE/SOWE, CNN/CNN, RNN/RNN}}{\maincolors}
	}
...
\begin{figure}
	\pointfigs{{Direct/{\shortstack{Non-compositional\\ Baseline}}, SOWE/SOWE, CNN/CNN, RNN/RNN}}{maincolors}{18}
