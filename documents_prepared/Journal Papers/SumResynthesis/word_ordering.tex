...
\newcommand{\displayunskip}{\vspace{0pt}} %does nothing, but here to mess with later
...
\end{gather*}
%
Visit (enter) every district exactly once. i.e. use every word exactly once. $\forall w_{i}\in\W\backslash\{\s,\ee\}$:
\displayunskip
\begin{gather*}
