...
\begin{frame}{How to solve objective function? Greedily}
	...
	\begin{itemize}
		...
		\item<2-> Very high dimensionality of selection vector\begin{itemize}
			...
			\item $\approx40,000$ for Brown Corpus\hfill $\approx160,000$ for Books Corpus\hspace{1em}
			\end{itemize}
...
\begin{frame}{Result: The longer the sentence, the worse recovery}
...
\begin{frame}{Conclusion: Split the sentence generation into selection then ordering.}
	\begin{itemize}
		...
		\vfill
		\item<2->Ordering: GA-TSP, over log-likelyhoods.
	\end{itemize}
\end{frame}
