...
$t$ can be bounded by considering how many times the smallest element of the vocabulary can fit into $S$.

$$t = \min_{\forall 1 \le i \le n}\: \left(\max_{\forall 1\le j \le V}\: \frac{S_i}{x_{ji}} \right)$$

The time complexity of the swap step is $$O(tVn)$$ also.
The complextity of the double swap step if $$t^2 V^2 n^2$$
