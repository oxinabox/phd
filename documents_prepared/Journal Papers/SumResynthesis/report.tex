...
\pgfplotstableset{
	columns/0/.style={
		string replace={glove50_jaccard}{50d GLoVE},
		string replace={glove100_jaccard}{100d GLoVE},
		string replace={glove200_jaccard}{200d GLoVE},
		string replace={glove300_jaccard}{300d GLoVE},
		string type,
		column name = {Model}
	}	
} 
...
\begin{table}
	\pgfplotstableread[col sep=comma, header=false]{data/selection_overall_len_scores.csv}\overall
