...
\begin{table}	
	...
	\resizebox{\linewidth}{!}{
		...
		columns={Process, Portion Perfect, Mean Precision,Mean Jaccard Index}
...
The sentences in \Cref{egbowman}, are short and use common words -- they are easy to resynthesis. These examples come from \textcite{Bowman2015SmoothGeneration}. The output of their VAE based approach can be compared to that of our two step approach. Of the three there were two exact match's, and one failure.
