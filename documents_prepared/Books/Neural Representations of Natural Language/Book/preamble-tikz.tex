\usepackage{tikz}
\usetikzlibrary{positioning, fit,  shapes.geometric, shapes.misc}
\usepackage{ifthen}
\usepackage{etoolbox}
...
\newcommand{\embtable}[4][F]{
	...
	\foreach \ii in {1,...,\tblmax} {
		...
		%
		\node({#2}\ii)[draw, tight, minimum width=4.2em, above = 0 mm of {{#2}\prev}.north]{\footnotesize$\varoast\varoast\varoast\varoast\varoast$};
