...
WordNet encodes this information for a lemma-synset pair using the SemCor corpus counts (this is also used for sense ordering, which is why most frequent sense  is sometimes called first sense.).
...
\aside[WSD with embeddings]{
	...
	As such they can be used as for a WSD system.
