...
There is not a canonical list of word se
...
\aside[Semantic Syllepsis]{
	...
	Consider the sentences: \natlang{John used to work for the \emph{newspaper} that you are reading.},
	and \natlang{I was going to \emph{dust} but there wasn't any}.
	In these sentences the emphasised words simultaneously have two different meanings.
	In the latter case: dust actually has is both a verb and a noun.
	As word sense disambiguation systems (and part of speech taggers), normally attempt to assign a single sense (and part of speech), to an each word, they are unable to handle these sentences.
