...
\begin{figure}
	...
	\begin{tikzpicture}[every node/.append style={tight}]
		\node[circle,draw](worduse){Word-use\\ \footnotesize e.g.\\ \footnotesize \natlang{Fred \underline{goes} shopping}};
		\node[circle, draw, above right = of worduse](pos){POS\\ \footnotesize e.g.\\ \footnotesize \emph{verb}};
		\node[circle, draw, below right = of worduse](lexeme){Lexeme\\ \footnotesize e.g. \\ \footnotesize \{\natlang{go}, \natlang{going},\\ \footnotesize \natlang{goes}, \natlang{went}\}};
		\node[circle, draw, below right = of pos](synset){Synset\\ \footnotesize e.g. \\ \footnotesize \{\natlang{go}, \natlang{move}, \\ \footnotesize \natlang{locomote}\}};
		...
		\node[circle, draw, above = 2 of synset.east](gloss){Gloss\\ \footnotesize e.g. \\ \footnotesize \emph{change location \ldots}};
		\draw[<->] (synset) edge node[labe] {has 1} (gloss);
		
		\node[circle, draw, right = of lexeme](lemma){Lemma\\ \footnotesize e.g. \\ \footnotesize \natlang{go}};
