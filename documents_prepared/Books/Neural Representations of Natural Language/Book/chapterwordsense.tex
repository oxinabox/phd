...
\begin{abstract}
	In this chapter, techniques for representing the multiple meanings of a single word is discussed.
	...
	The inductive techniques can be sub-classified as clustering, or as as 
...
\aside[Lemmatization]{WordNet is indexed by lemmas. This in essence means with tense and plurality information removed. WordNet comes with a lemmatizer called morphy to do this.(c.f. stemming)}
...
\begin{figure}
	\caption{The relationship between terms used to discuss word sense problems.
		...
		For WSD tasks the word-use is normally pretagged with its POS tag, and its corresponding lemma,
		as these can be found with very high reliability by a POS tagger and by a lemmatizer respectively.
	}
