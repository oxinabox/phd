...
This is in-contrast to \cite{iyyer2014generating}, which works over dependency parse trees.


\subsection{Unfolding Output layers}
\textcite{SocherEtAl2011:PoolRAE} and \textcite{iyyer2014generating}
are what have been call Unfolding Recursive AutoEncoders (URAE)


Simpler than this is the (nonunfolding) Recursive Autoencoder,
