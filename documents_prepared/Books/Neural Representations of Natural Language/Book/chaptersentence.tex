...
\subsection{Context Vector Models}
...
There have been significant issues raise with attempting to replicate the results of \textcite{le2014distributed} \pcite{lau2016doc2vecissues}.
It is been concluded that the hyper-parameters reported in the original paper were not correct.
\footnote{The demonstration of the issues with hyper-parameters  was discussed in the email thread at \url{https://groups.google.com/
forum/#!topic/word2vec-toolkit/Q49FIrNO}. However this no-longer exists, and we have been unable to locate any archived copies.}
\textcite{lau2016doc2vecissues} showed that with the right tuning these paragraph vector models could perform very well on many tasks.
