...
Conversely, the representation that is suitable for predicting the next link to make, is a composed representation.
...
In the dependency tree work which followed, \tcite{socherDTRNN}, \tcite{iyyer2014neural}, and \tcite{iyyer2014generating} use these dependency relationships to use different composition matrices.
