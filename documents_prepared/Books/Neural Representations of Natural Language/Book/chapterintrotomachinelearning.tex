...
\subsubsection{RELU6}
\aside[Why are we bringing up ReLU6?]{ReLU6 is one of the more obsure activation functions. As such it may seem a bizare inclusion in this shorter introduction. However, we have found it surprisingly sucessful as an activation function, e.g. in the Auto-encoder example.}
...
In either case, almost all optimisers used for neural networks rely on gradient descent.
