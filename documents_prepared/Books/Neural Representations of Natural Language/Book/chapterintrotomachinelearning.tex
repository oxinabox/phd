...
\begin{figure}
	...
	\caption{The unrolled structure of an RNN for us in Encoding, Decoding and Encoding-Decoding (sequence-to-sequence) problems. RU is the recurrent unit -- the feed-forward neural network which reoccurs at each time step.}.
	\label{fig-rnns}
\end{figure}
