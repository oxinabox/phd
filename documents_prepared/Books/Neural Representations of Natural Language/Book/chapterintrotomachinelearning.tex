...
\begin{figure}
	\pdfcomment{It would be nice to just stick this figure only in the margin}
...
For example the reverse problem, going from words to the most likely point in color space \pdfcomment{Cite myself here, it is a good matched example}.
...
The output of the final timestep can be the true output.
