...
The recurrent unit takes at each time-step, an input for that time-step, some representation its of state for the RU at the previous time-step; and it produces an output for this time-step, and its state representation for the next time-step.
...
\begin{figure}
	...
	\label{fig-ru}
	\resizebox{\textwidth}{!}{\input{./figs/chapterintromachinelearning/rnn-unit.tikz}}
\end{figure}
