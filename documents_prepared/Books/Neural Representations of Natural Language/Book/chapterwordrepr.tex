...
\DeclareFieldFormat{sidecite}{#1}%\aside{#1}}
\DeclareNameFormat{sidecite}{
	\aside{\namepartfamily}
}

\newbibmacro{sidecite}{%
	%\printnames[sidecite]{labelname}%
	\printfield[sidecite]{year}
	\printfield[sidecite]{labeltitle}
}
...
{\usebibmacro{prenote}}%
{%
	\expandafter\protected@edef\helpermacro{\expandafter\printfield{year}}%
%		
	\usebibmacro{citeindex}%
	\usebibmacro{cite}
%	\aside{\usebibmacro{sidecite}}%
	\aside{\helpermacro}
}
{\multicitedelim}
...
\tcite{collobert2008unified} a



\subsection{RNN Language Models}
\tcite{mikolov2011RnnLM,mikolov2010recurrent,6163930} a
...
\subsection{CBOW}
\tcite{mikolov2013linguisticsubstructures,mikolovSkip} a
