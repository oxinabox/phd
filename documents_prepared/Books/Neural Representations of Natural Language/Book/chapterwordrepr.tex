...
The method of \tcite{NPLM} implicitly learns this information in doing the language modeling task.
...
s_{max}\left(U_2 \: \sigma\left(U_1\left[C_{w_{i-1}}; C_{w_{i-2}}\right] + b_1\right)+b_2\right)
\end{multline}
%
...
\\  &  U_3 \left[ C_{w_{i-1}};...; C_{w_{i-n}}\right] 
\\  & + U_2 \: \sigma\left( U_1\left[C_{w_{i-1}};...; C_{w_{i-n}} \right] + b_1\right)
\\  & +b_2)
\end{align}
It includes a layer-skip, which is primarily present only as connivance to aid in the learning.
