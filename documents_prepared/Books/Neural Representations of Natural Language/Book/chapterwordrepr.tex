...
It is on these systems that evaluation the analogy tasks became well known, though they were considered earlier on RNN neural language models \pcite{}.
...
As we have now concluded that neural predictive co-location models are functional equivelent to matrix factorisation of co-location counts,
