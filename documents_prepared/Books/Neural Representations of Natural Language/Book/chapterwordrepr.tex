...
s_{max}\left(U_2 \: \sigma\left(U_1\left[C_{w_{n-1}}; C_{w_{n-2}}\right] + b_1\right)+b_2\right)
\end{multline}

where $U_1,\: U_2,\: b_1,\: b_2$ are the weight matrices and biases of the network, and $C_{w_{n-1}}$ and $C_{w_{n-2}}$ are the looked-up word embedding for the previous two words, from the embedding table $C$.
