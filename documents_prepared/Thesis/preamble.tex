...
\def\bordercolor{\backgroundcolor}
...
\DeclareDocumentCommand{\inputpublication}{m}{
	...
	\definecolor{randomcolor}{RGB}{\pdfuniformdeviate 255,\pdfuniformdeviate 255,\pdfuniformdeviate 255}%	
	\xdef\bordercolor{randomcolor}
	...
	\input{pub#1.tex}
	\xdef\bordercolor{\backgroundcolor}
}
