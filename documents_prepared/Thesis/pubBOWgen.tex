...
\preamble{This paper was presented at the 17th Conference on Intelligent Text Processing and Computational Linguistics, in 2016. Where it received the award for best student publication.}
%
\begin{abstract}
...
The rest of the paper is organized into the following sections. \Cref{relworkBG} introduces the area, discussing in general sentence models, and prior work on generation. \Cref{frameworkBG} explains the problem in detail and our algorithm for solving it. \Cref{evalsettingsBG} described the settings used for evaluation. \Cref{resultsBG} discusses the results of this evaluation. The paper presents its conclusions in \Cref{conclusionBOWgen}, including a discussion of future work.
...
\section{Results and Discussion} \label{resultsBG}
...
\begin{figure}
	\pgfplotstableread[col sep=comma,precision=0,header=has colnames]{data/selection_len_scores.csv}{\sellenscores}
	...
	\begin{axis}[xlabel=Ground Truth Sentence Length,
					...
					x tick label style={/pgf/number format/.cd,
						...
						precision=0,
						/tikz/.cd},
					width=12.5cm,height=6.3cm,cycle list name=exotic]
