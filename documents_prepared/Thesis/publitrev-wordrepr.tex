...
\preamble{This chapter originally appeared as Chapter 3 of the book ``Neural Representations of Natural Language'', published by by Springer.\copywarn{}}
...
This layer-bypass is an unusual feature, not present in most future work building upon this, such as \tcite{schwenk2004efficient}.
Though in general it is not an unheard of technique in neural network machine learning.


This neural network is where we will begin our study of using neural networks with vector representations of words.
...
In \tcite{mikolov2010recurrent} an RNN is used for language modelling, as shown in \Cref{fig:rnn-neural-language-model}.
Using the terminology of Chapter 2 of \pcite{NRoNL}, this is an encoder RNN, made using Basic Recurrent Units.
