...
However; such cases are rarer than one might expect is demonstrated in \Cref{SOWE2Sent}.
...
\todo{There are a few papers which show RNNs are only as powerful as Regex, or that they don't have much memory}
...
\subsection{\Cref{ColorEst} \detailcite{White2018ColorEst}}
...
\subsection{\Cref{RefittingSenses} \detailcite{WhiteRefittingSenses}}
...
\subsection{\Cref{NovelPerspective} \detailcite{novelperspective}}
...
\subsection{\Cref{BOWgen} \detailcite{White2015BOWgen}}
...
\subsection{\Cref{SOWE2Sent} \detailcite{White2016a}}
