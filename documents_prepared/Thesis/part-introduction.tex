...
These investigations It constitute the bulk of this research effort.
...
\subsection*{\Cref{SentVecMeaning}: \detailcite{White2015SentVecMeaning}}
...
While real world task has its own important value, it is harder to judge the generalisation ability from such cases.
...
Estimating colors from natural language color name, has pragmatic uses.
...
The preimage of a point in the natural language space (e.g. a sentence),
...
While we would not normally think of the SOWE sentence the representation space as one for which there would be an easy alignment to the meaning space,
