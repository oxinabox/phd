...
\tcite{acl2018bleuopposedmeaning} found that taking a mean of word embeddings outperformed almost all their more sophisticated machine-translation-based sentence representations when used on classification and paraphrase detection tasks.
...
\tcite{ac2018probingsentencevectors} constructed 10 probing tasks to isolate the some of the information captured by sentence representations.
...
This is particularly the case where the need for more sophisticated processing is limited (as in \Cref{ColorDist}).
