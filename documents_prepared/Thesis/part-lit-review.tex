...
\newcommand{\redactedbody}{\vfill{} \large{}\sffamily{}
	Chapters 2, 3, and 4, are not available in the publically archieved copy of the thesis for copyright reasons.
	...
	It also may be possible to aquire a copy from the authors.
...
\inputpublication{litrev-wordrepr-redacted}
\inputpublication{litrev-wordsense-redacted}
\inputpublication{litrev-sentence-redacted}
